...
const auth = "https://cdni.iconscout.com/illustration/premium/thumb/woman-shopping-online-4344416-3613889.png";
            ...
            {isSubmitting ? (
                ...
                <div className="container bg-primaryBg mt-5 sm:mt-0 md:mt-0 lg:mt-0 py-[2px]">
                    <div className="flex items-center flex-col sm:flex-row md:flow-row lg:flex-row my-10 mx-auto w-full sm:w-[70vw] md:w-[70vw] lg:w-[70vw] min-h-[500px] md:h-[80vh] lg:h-[80vh] bg-white shadow-[0px_0px_8px_2px_rgba(212,212,212,0.6)] ">
                        {/* left view  */}
                        <div className=" w-full md:w-[40%] lg:w-[40%] h-full bg-primaryPurple">
                        ...
                        <div className="p-10 w-full  sm:w-[60%] md:w-[60%] lg:w-[60%] ">
                            <div className="flex items-center flex-col h-full w-full">
                                ...
                                >
                                    <div className="text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7 pt-3 ">
                                        ...
                                        <div className="relative flex flex-col">
                                            <button className="bg-gradient-to-r from-orange-500 to-pink-500 uppercase text-white text-[14px] font-[500] rounded-sm px-2 py-1">
                                                Continue
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div className="relative mt-4 w-full">
                                    <Link to="/login">
                                        <button className="bg-white text-primaryPurple w-[90%] font-[600] text-[12px] ml-[5%] px-4 py-2  shadow-[0px_0px_8px_2px_rgba(212,212,212,0.6)] hover:shadow-[0px_0px_8px_2px_rgba(212,212,212,0.8)]  transition-all">
