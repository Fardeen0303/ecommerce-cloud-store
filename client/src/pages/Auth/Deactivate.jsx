        ...
        <>
            ...
            <div className="flex flex-col sm:flex-row w-full items-center sm:items-start p-4 h-full ">
                    ...
                    <div>
                        ...
                        <div className="text-[12px] text-slate-500 p-4">
                            <ul className="list-disc leading-8">
                                <li>
                                    You are logged out of your EliteMarket Account
                                </li>
                                <li>
                                    Your public profile on EliteMarket is no longer
                                    visible
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    promotional emails from EliteMarket
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="sm:w-[50%] flex flex-col gap-5 items-center p-2  ">
                    ...
                    <Link
                        to="/user/dashboard"
                        className="uppercase text-primaryPurple font-[600] text-[14px] flex items-center justify-center w-full"
                    >
                        No, Let me Stay
                    </Link>
                </div>
