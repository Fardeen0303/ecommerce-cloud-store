            ...
            <div className="bg-white flex flex-col justify-center rounded-sm sm:shadow-md overflow-y-auto">
                <div className="flex flex-col justify-center border-b-[1px]">
                    <div className="flex flex-row items-center gap-6 pl-[10px] py-[8px]">
                        <PersonIcon className="text-primaryPurple text-[16px]" />
                    ...
                    <div className="flex flex-col  text-black font-[300] text-[14px] mb-2 mt-0 ">
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                isActive
                                    ? "font-[600] text-primaryPurple bg-[#f1f3f5]"
                                    : ""
                            }
                        >
                            <div className=" h-[40px] px-[60px] flex items-center hover:text-primaryPurple hover:bg-[#f1f3f5]">
                                Profile Information
                            </div>
                        </NavLink>
                ...
                <div className="flex flex-col justify-center border-b-[1px]">
                    <div className="flex flex-row items-center gap-6 pl-[10px] py-[8px]">
                        <BarChartIcon className="text-primaryPurple text-[16px]" />
                        <div className="font-[600] text-[14px] text-slate-500">
                            DASHBOARD
                        </div>
                    </div>
                ...
                <div className="flex flex-col justify-center border-b-[1px]">
                    <div className="flex flex-row items-center gap-6 pl-[10px] py-[8px] group">
                        <PowerSettingsNewIcon className="text-primaryPurple text-[16px]" />
                        <button
                            className="font-[600] text-[14px] w-full h-[40px] flex items-center text-slate-500 group-hover:text-primaryPurple"
