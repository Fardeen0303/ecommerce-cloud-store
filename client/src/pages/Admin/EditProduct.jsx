...
const EditProduct = () => {
    ...
    const handleLogoChange = (e) => {
        ...
        if (file.size > MAX_IMAGE_SIZE) {
            toast.warning("Logo image size exceeds 2 MB!");
            return;
        }
    ...
    const handleProductImageChange = (e) => {
        ...
        files.forEach((file) => {
            ...
            if (file.size > MAX_IMAGE_SIZE) {
                toast.warning("One of the product images exceeds 2 MB");
                ...
                >
                    <div className="flex flex-col flex-1 gap-3 m-2 ">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex justify-between items-center border rounded">
                                ...
                                <span
                                    ...
                                    className="py-2 px-6 bg-primaryPurple text-white rounded-r hover:shadow-lg cursor-pointer"
                                >
                                    Add
                                </span>
                            </div>
                        ...
                        <div className="flex flex-col sm:flex-row justify-between gap-4 items-start">
                            ...
                            <label className="rounded bg-primaryPurple text-center cursor-pointer text-white py-2 px-2.5 shadow hover:shadow-lg">
                                <input
                                    type="file"
                                    name="logo"
                                    accept="image/*"
                        ...
                        <div className="flex justify-between gap-2 items-center">
                            ...
                            <span
                                onClick={() => addSpecs()}
                                className="py-2 px-6 bg-primaryPurple text-white rounded hover:shadow-lg cursor-pointer"
                            >
                                Add
                            </span>
                        </div>
                        ...
                        <label className="rounded font-medium bg-primaryPurple text-center cursor-pointer text-white p-2 shadow hover:shadow-lg my-2">
                            <input
                                type="file"
                                name="images"
                                accept="image/*"
                        ...
                        <div className="flex  items-center gap-4 justify-between">
                            <input
                                form="mainForm"
                                type="submit"
                                className="bg-gradient-to-r from-orange-500 to-pink-500 uppercase w-full p-3 text-white font-medium rounded shadow hover:shadow-lg cursor-pointer"
                                value="Update"
                            />
                            <Link
