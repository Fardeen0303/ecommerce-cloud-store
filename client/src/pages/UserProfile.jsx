...
const UserProfile = () => {
    ...
    const handleNameSubmit = async (e) => {
        ...
        try {
            ...
            Cookies.set("auth", JSON.stringify({ ...auth, user: { ...auth.user, name: name }, token: response.data.token }));
    ...
    const handleEmailSubmit = async (e) => {
        ...
        try {
            ...
            Cookies.set("auth", JSON.stringify({ ...auth, user: { ...auth.user, email: email }, token: response.data.token }));
            toast.success(response.data.message);
        } catch (error) {
            console.log(error);
        }
    ...
    const handlePhoneSubmit = async (e) => {
        ...
        try {
            ...
            setAuth({
                ...auth,
                user: { ...auth.user, phone: phone },
            });
            Cookies.set("auth", JSON.stringify({ ...auth, user: { ...auth.user, phone: phone }, token: response.data.token }));
            toast.success(response.data.message);
            ...
            <div className="w-full flex flex-col items-start p-5 gap-10">
                <div className="flex flex-col items-start gap-4">
                    <div className="flex gap-5">
                        ...
                        <button
                            className="text-[14px] text-primaryPurple font-[500]"
                    ...
                    <div className=" h-[50px]">
                        {profile ? (
                            ...
                            >
                                ...
                                <button
                                    type="submit"
                                    className="bg-primaryPurple text-white font-[600] w-[80px] h-[40px] px-4 py-2 rounded-sm"
                    ...
                    <div className="flex gap-6 ">
                        {emailSection ? (
                            <input
                                ...
                                className="border-2 p-2 w-[220px] focus:outline-primaryPurple focus:outline-1"
                ...
                {/* deactivate account */}
                <div className="text-[14px] text-primaryPurple font-[500] mt-4 -mb-4">
