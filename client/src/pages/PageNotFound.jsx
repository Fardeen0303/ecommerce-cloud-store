                ...
                <div className="relative">
                    <div className="absolute">
                        <div>
                            ...
                            <Link
                                to="/"
                                className="sm:w-full lg:w-auto border rounded-md py-2 px-4 text-center bg-primaryPurple text-white hover:shadow-md focus:outline-none focus:ring-2 focus:ring-opacity-50 text-[18px]"
                            >
                                Take me there!
                            </Link>
                        </div>
