                ...
                <div className="flex flex-col items-center gap-2 w-full px-4 py-6 relative hover:shadow-lg rounded-sm">
                    ...
                    <div className="flex flex-col gap-2 items-start w-full">
                        ...
                        <span className="text-sm text-gray-500 font-medium flex gap-2 items-start justify-between">
                            ...
                            <span className="px-2 py-0.5 bg-gradient-to-r from-purple-600 to-blue-600 text-white text-[10px] font-bold rounded-full flex items-center gap-1">
                                <VerifiedUserIcon sx={{ fontSize: "10px" }} />
                                Elite
                            </span>
                        </span>
                        {/* <!-- rating badge --> */}
