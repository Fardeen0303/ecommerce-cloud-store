    ...
    const reviewSubmitHandler = async () => {
        ...
        try {
            const res = await axios.post(
                `${import.meta.env.VITE_SERVER_URL}/api/v1/product/review`,
                {
                    rating,
                    comment,
                    productId,
                                ...
                                <div className="flex flex-col gap-3 mb-4">
                                    ...
                                    <span className="text-md text-gray-500 font-medium flex gap-2 items-center">
                                        ...
                                        <span className="px-3 py-1 bg-gradient-to-r from-purple-600 to-blue-600 text-white text-xs font-bold rounded-full flex items-center gap-1">
                                            <VerifiedUserIcon sx={{ fontSize: "14px" }} />
                                            EliteMarket Assured
                                        </span>
                                    </span>
                                    {/* <!-- rating badge --> */}
                                    ...
                                    <div className="flex gap-8 mt-2 items-center text-sm">
                                        ...
                                        <Link
                                            className="font-medium text-primaryPurple -ml-5"
                                            to="/"
                                        >
                                            Know More
                                        </Link>
                                    ...
                                    <div className="flex gap-16 mt-4 items-center text-sm font-medium">
                                        ...
                                        <Link
                                            className="font-medium text-primaryPurple ml-3"
                                            to="/"
                                        >
                                            {product?.brand?.name}
                                        </Link>
